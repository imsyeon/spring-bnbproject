...
<nav>
	...
	<div class="menu">
		<ul>
			...
			<li><a href="getBoardList.do">집구경하기</a></li>
		</ul>
	</div>
</nav>
<body>
	...
	<div class="container">
		<div class="py-5 text-center">
			<h2><%=board.getBoard_nickname()%>님의 멋진 집을 구경하세요!
				</h4>
			</h2>

		</div>
	<div id="imgblock" style="display :  inline-block ;">
				<div style="width:400px; height:300px; margin: 5px; border:1px ; float:left;">
			
				
					<img class="imgfile"
						src="resources/fileupload/<%=board.getFileName()%>">
				</div>
				<div style="width:400px; height:300px; margin: 5px; border:1px;  float:left;">
					<img class="imgfile"
						src="resources/fileupload/<%=board.getFileName2()%>">
				</div>
				</div>
			<div class="row">
				<div class="col-md-10 mb-3">
					...
					<div>
						<%=board.getBoard_title().replace("\r\n", "<br>")%>
					</div>
				</div>
				<div class="col-md-10 mb-3">
					<label for="firstName">Name</label>
					<div>
						<%=board.getBoard_nickname().replace("\r\n", "<br>")%>
					</div>
				</div>
			</div>
		...
		<div class="mb-3">
			...
			<div class="row">
				<div class="col-md-5 mb-3">
					...
					<div>
						<%=board.getBoard_reion().replace("\r\n", "<br>")%>
					</div>
				</div>
				<div class="col-md-5 mb-3">
					<label for="RegDate">RegDate</label>
					<div>
						<%=board.getBoard_regdate().replace("\r\n", "<br>")%>
					</div>
				</div>
				<div class="col-md-5 mb-3">
				...
				<form action="updateBoard.jsp" name="formCheck" method="post">
					<input type="submit" value="수정하기" />
				</form>
				<form action="deleteBoard.do"  name="formCheck"  method="post">
					<input type="hidden" name="board_idx"
							value="<%=board.getBoard_idx()%>">
					<input type="submit" id="submitBtn" value="삭제하기" />
				</form>
